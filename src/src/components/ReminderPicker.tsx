import React from 'react';
    ...
    const ReminderPicker: React.FC<ReminderPickerProps> = ({ selectedTime, onSelect, onClose }) => {
      ...
      return (
        <div
          className={`bg-white dark:bg-gray-800 rounded-lg shadow-xl p-2 w-64`}
          ...
          {times.map(({ label, value }) => (
            <button
              ...
              className={`
                ...
                ${selectedTime === value ? 'bg-green-600 text-white' : `text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700`}
              `}
            >
